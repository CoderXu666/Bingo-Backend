...
/**
 * @Author: 徐志斌
 * @CreateTime: 2023-09-06  16:22
 * @Description: 打印Controller接口耗时
 * @Version: 1.0
 */
@Slf4j
@Aspect
...
public class WebLogAspect {
     ...
     * 打印全局Controller接口耗时
     */
    @Around("execution(* com.bingo.controller..*.*(..))")
    public Object saveLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 打印参数日志
        log.info("------------------------[{}][{}]【request:{}】------------------------", method, uri, paramList);
        ...
        // 打印耗时日志
        log.info("------------------------[{}]【response:{}】[cost:{}ms]------------------------", uri, result, cost);
